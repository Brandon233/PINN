...
if Pretrain:
    parser.add_argument('--phase', choices=['pretrain', 'train'], default='pretrain')
    ...
    parser.add_argument('--processed_path', default='fig_1/tmp/mendota/pretrain/inputs')
    ...
    parser.add_argument('--glm_file', default='fig_1/tmp/mendota/shared/raw_data/me_predict_pb0.csv')
    parser.add_argument('--ice_file', default='fig_1/tmp/mendota/shared/raw_data/mendota_pretrainer_ice_flags.csv')
    parser.add_argument('--processed_path', default='fig_1/tmp/mendota/train/inputs')
    args = parser.parse_args()
...
np.save(os.path.join(args.processed_path, 'labels_train.npy'), labels)
